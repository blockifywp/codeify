 ...
 */
?>
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|xxl","bottom":"0"}}},"gradient":"radial-up","layout":{"type":"constrained"}} -->
...
<p class="has-primary-900-color has-text-color has-link-color">{post_title}</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<div class="wp-block-columns are-vertically-aligned-center has-neutral-900-background-color has-background" style="padding-top:var(--wp--preset--spacing--lg);padding-right:var(--wp--preset--spacing--lg);padding-bottom:var(--wp--preset--spacing--lg);padding-left:var(--wp--preset--spacing--lg)"><!-- wp:column {"verticalAlignment":"center"} -->
...
<div class="wp-block-group"><!-- wp:post-title {"isLink":true,"gradient":"primary-background","fontSize":"40"} /--></div>
<!-- /wp:group -->
<!-- wp:post-excerpt {"moreText":"","excerptLength":20} /-->
<!-- wp:post-author {"showBio":false,"byline":""} /--></div>
<!-- /wp:column -->
...
<!-- /wp:query --></div>
<!-- /wp:group -->
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"bottom":"var:preset|spacing|xl","top":"var:preset|spacing|xl"},"margin":{"top":"0","bottom":"0"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--xl);padding-bottom:var(--wp--preset--spacing--xl)"><!-- wp:query {"queryId":0,"query":{"perPage":"12","pages":"","offset":"1","postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false},"align":"wide","layout":{"inherit":false},"style":{"spacing":{"blockGap":"1.5em"}}} -->
...
<!-- /wp:query --></div>
<!-- /wp:group -->
<!-- wp:blockify/pattern {"slug":"cta-center"} /-->
...
<!-- wp:group {"tagName":"main","align":"full","style":{"position":{"all":"relative"},"overflow":{"all":""},"zIndex":{"all":"1"}},"layout":{"type":"constrained"}} -->
<main class="wp-block-group alignfull" id="site-main"><!-- wp:post-content {"style":{"position":{"all":"relative"},"zIndex":{"all":"1"}},"align":"wide","className":"margin-auto"} /--></main>
<!-- /wp:group -->
